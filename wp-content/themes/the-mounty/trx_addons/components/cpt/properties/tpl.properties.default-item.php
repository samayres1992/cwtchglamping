		...
		trx_addons_get_template_part('templates/tpl.featured.php',
										...
										apply_filters('trx_addons_filter_args_featured', array(
															...
															'thumb_size' => apply_filters('trx_addons_filter_thumb_size',
																							...
																							'properties-default'),
															'post_info' => '<div class="sc_properties_image_info"><div class="sc_properties_item_price">'
                                                                            ...
                                                                            . '<div class="sc_properties_item_labels">'
																				. trx_addons_get_post_terms('', get_the_ID(), TRX_ADDONS_CPT_PROPERTIES_TAXONOMY_LABELS, false)
																			. '</div></div>'
																			. (!empty($meta['hot']) ? '<div class="hot-label">' . esc_html__("HOT", 'the-mounty') . '</div>' : '')
															), 'properties-default'
														)
									);
	}
	?><div class="sc_properties_item_info">
		<div class="sc_properties_item_header"><?php
			...
			?><span class="sc_properties_item_compare trx_addons_icon-balance-scale<?php
					...
					title="<?php esc_attr_e('Add to compare list', 'the-mounty'); ?>"></span>
		</div>
		<div class="sc_properties_item_options">
			<div class="sc_properties_item_row sc_properties_item_row_info"><?php
				// ID
				if (!empty($meta['id'])) {
					?><span class="sc_properties_item_option sc_properties_item_id" title="<?php esc_attr_e('Property ID', 'the-mounty'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-map"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('ID:', 'the-mounty'); ?></span>
						</span>
				...
				// Year built
				if (!empty($meta['built'])) {
					?><span class="sc_properties_item_option sc_properties_item_built" title="<?php esc_attr_e('Year built', 'the-mounty'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-building"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Built:', 'the-mounty'); ?></span>
						</span>
				...
				if (!empty($meta['area_size'])) {
					?><span class="sc_properties_item_option sc_properties_item_area" title="<?php esc_attr_e('Area size', 'the-mounty'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-resize-full-alt"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Area:', 'the-mounty'); ?></span>
						</span>
			...
			<div class="sc_properties_item_row sc_properties_item_row_info"><?php
				...
				if (!empty($meta['bedrooms'])) {
					?><span class="sc_properties_item_option sc_properties_item_bedrooms" title="<?php esc_attr_e('Bedrooms number', 'the-mounty'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-bed"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Beds:', 'the-mounty'); ?></span>
						</span>
				...
				if (!empty($meta['bathrooms'])) {
					?><span class="sc_properties_item_option sc_properties_item_bathrooms" title="<?php esc_attr_e('Bathrooms number', 'the-mounty'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-water"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Baths:', 'the-mounty'); ?></span>
						</span>
				...
				if (!empty($meta['garages'])) {
					?><span class="sc_properties_item_option sc_properties_item_garages" title="<?php esc_attr_e('Garages number and size', 'the-mounty'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-car"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Garages:', 'the-mounty'); ?></span>
						</span>
						<span class="sc_properties_item_option_data"><?php
			...
			<div class="sc_properties_item_row sc_properties_item_row_address"><?php
				// Address
				?><span class="sc_properties_item_option sc_properties_item_address" title="<?php esc_attr_e('Address', 'the-mounty'); ?>">
					<span class="sc_properties_item_option_label">
						<span class="sc_properties_item_option_label_icon trx_addons_icon-home"></span>
						<span class="sc_properties_item_option_label_text"><?php esc_html_e('Address:', 'the-mounty'); ?></span>
					</span>
					<span class="sc_properties_item_option_data"><?php 
			...
			<div class="sc_properties_item_row sc_properties_item_row_meta"><?php
				...
				if ($meta['agent_type']!='none' && ($meta['agent_type']=='author' || $meta['agent']!=0)) {
					?><span class="sc_properties_item_option sc_properties_item_author" title="<?php esc_attr_e('Agent or post author', 'the-mounty'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-user-alt"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Agent:', 'the-mounty'); ?></span>
						</span>
						<span class="sc_properties_item_option_data"><?php
				...
				// Publish date
				?><span class="sc_properties_item_option sc_properties_item_date" title="<?php esc_attr_e('Publish date', 'the-mounty'); ?>">
					<span class="sc_properties_item_option_label">
						<span class="sc_properties_item_option_label_icon trx_addons_icon-calendar"></span>
						<span class="sc_properties_item_option_label_text"><?php esc_html_e('Added:', 'the-mounty'); ?></span>
					</span>
					<span class="sc_properties_item_option_data"><?php
            ...
            <div class="properties_page_features_list">
                ...
                if (!function_exists('trx_addons_get_post_terms_with_icon')) {
                    function trx_addons_get_post_terms_with_icon($delimiter=', ', $id=false, $taxonomy='category', $links=true) {
                        $output = '';
                        ...
                        if ( !empty( $terms ) && is_array($terms) ) {
                            ...
                            foreach( $terms as $term ) {
                                ...
                                $output .= ($links
                                    ...
                                    . (!empty($icon_name) ? '<span class="properties_list_icon '. esc_attr($icon_name) .'"></span>' : '<span class="properties_list_icon icon-info"></span>')
                                    . '<span class="properties_list_text">' . esc_html( $term->name ) . '</span>'
                                    . ($i<$cnt ? $delimiter : '')
                                    . ($links ? '</a>' : '</span>');
                            }
                        }
                ...
                trx_addons_show_layout(trx_addons_get_post_terms_with_icon(' ', get_the_ID(), TRX_ADDONS_CPT_PROPERTIES_TAXONOMY_FEATURES)); ?>
			</div><?php
		?></div>
	</div>
</div>

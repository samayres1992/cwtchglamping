		...
		if ( !trx_addons_sc_layouts_showed('featured') && has_post_thumbnail() ) {
			?><div class="team_member_featured">
				<div class="team_member_avatar">
					<?php
					the_post_thumbnail(
										apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('masonry'), 'team-single'),
		...
		?><div class="team_member_description"><?php
			...
			if (!empty($meta['brief_info'])) {
				...
				<div class="team_member_brief_info">
					<h5 class="team_member_brief_info_title"><?php esc_attr_e('Brief info', 'the-mounty'); ?></h5>

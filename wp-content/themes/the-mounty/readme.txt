...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About The Mounty'.
Please install and activate it before starting to use the theme The Mounty.
...
Theme documentation is available on http://themounty.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in The Mounty is Fontello.

...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	if (THE_MOUNTY_STORAGE['button_hover'] && THE_MOUNTY_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]):not([class*="xdsoft_"]):not([class*="tribe-events-c-top-bar__"]):not([class*="tribe-events-calendar-month__day-cell"]),\
				.theme_button:not([class*="sc_button_hover_"]),\
				.sc_button:not([class*="sc_button_simple"]):not([class*="sc_button_hover_"]),\
				.sc_form_field button:not([class*="sc_button_hover_"]),\
				.post_item .more-link:not([class*="sc_button_hover_"]),\
				.trx_addons_hover_content .trx_addons_hover_links a:not([class*="sc_button_hover_"]),\
				.the_mounty_tabs .the_mounty_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				.woocommerce .button:not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]):not([class*="wc-forward"]),\
				.woocommerce-page .button:not([class*="shop_"]):not([class*="view"]):not([class*="sc_button_hover_"]):not([class*="wc-forward"]),\
				#buddypress a.button:not([class*="sc_button_hover_"])\
				').addClass('sc_button_hover_just_init sc_button_hover_'+THE_MOUNTY_STORAGE['button_hover']);
		if (THE_MOUNTY_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
            	...
            	.the_mounty_tabs .the_mounty_tabs_titles li a:not([class*="sc_button_hover_style_"])\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+THE_MOUNTY_STORAGE['button_hover']);

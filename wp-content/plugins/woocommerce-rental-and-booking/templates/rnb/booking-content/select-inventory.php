...
<div class="payable-inventory rnb-component-wrapper rnb-select-wrapper rq-sidebar-select rnb-booking-inventory" <?php echo (count($inventories) < 2) ? 'style="display:none"' : ''; ?>>

...
use REDQ_RnB\ADMIN\Term_Meta_Text;
use REDQ_RnB\ADMIN\Term_Meta_Image;
use REDQ_RnB\ADMIN\Term_Meta_Select;
use REDQ_RnB\ADMIN\Term_Meta_Color;
use REDQ_RnB\ADMIN\Term_Meta_Icon;
...
trait Admin_Trait
{
    ...
    {
        new Term_Meta_Text($taxonomy, $args);
    }
    ...
    {
        new Term_Meta_Icon($taxonomy, $args);
    }
    ...
    {
        new Term_Meta_Image($taxonomy, $args);
    }
    ...
    {
        new Term_Meta_Select($taxonomy, $args);
    }
}

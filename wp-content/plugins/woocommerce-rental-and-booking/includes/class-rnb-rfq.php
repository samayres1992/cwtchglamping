...
class Handle_RFQ
{
    ...
    public function request_quote_endpoint_content()
    {
        $this->rfq_assets();

        wc_get_template('myaccount/request-quote.php', $args = array(), $template_path = '', RNB_PACKAGE_TEMPLATE_PATH);
    }

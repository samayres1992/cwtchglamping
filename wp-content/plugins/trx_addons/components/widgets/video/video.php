...
class trx_addons_widget_video extends TRX_Addons_Widget {
	...
	function widget( $args, $instance ) {
		...
		$cover_title    = isset($instance['cover_title']) ? $instance['cover_title'] : '';
		$cover_subtitle = isset($instance['cover_subtitle']) ? $instance['cover_subtitle'] : '';
		...
		trx_addons_get_template_part(TRX_ADDONS_PLUGIN_WIDGETS . 'video/tpl.default.php',
										...
										apply_filters('trx_addons_filter_widget_args',
											array_merge($args, compact('title', 'embed', 'link', 'cover', 'cover_title', 'cover_subtitle', 'popup')),
	...
	function update( $new_instance, $instance ) {
		...
		$instance['cover_title'] = strip_tags( $new_instance['cover_title'] );
		$instance['cover_subtitle'] = strip_tags( $new_instance['cover_subtitle'] );
	...
	function form( $instance ) {
		...
		$this->show_field(array('name' => 'cover_title',
								'title' => __('Cover title', 'trx_addons'),
								'value' => $instance['cover_title'],
								'type' => 'text'));
		
		$this->show_field(array('name' => 'cover_subtitle',
								'title' => __('Cover subtitle', 'trx_addons'),
								'value' => $instance['cover_subtitle'],
								'type' => 'text'));
		...
		return apply_filters('trx_addons_sc_map', array(
				...
				"params" => array_merge(
					array(
						...
						array(
                            'param_name' => 'cover_title',
                            'heading' => esc_html__('Cover Title', 'basekit'),
                            'description' => wp_kses_data( __('Cover Title', 'basekit') ),
						...
						array(
                            'param_name' => 'cover_subtitle',
                            'heading' => esc_html__('Cover Subtitle', 'basekit'),
                            'description' => wp_kses_data( __('Cover Subtitle', 'basekit') ),
                            'edit_field_class' => 'vc_col-sm-12',
                            'dependency' => array(
                                'element' => 'cover',
                                'not_empty' => true
